...
Authority could use with [Auth](http://github.com/qor/auth) to get current user, handle sessions, you could use it, or implement your own [AuthInterface](http://godoc.org/github.com/ductrung-nguyen/auth/authority#AuthInterface)

```go
import (
  "github.com/ductrung-nguyen/auth"
  "github.com/ductrung-nguyen/auth/authority"
...
Authority provides some [Rules](http://godoc.org/github.com/ductrung-nguyen/auth/authority#Rule) to make you define them easily, used like:

...
import (
	...
	"github.com/ductrung-nguyen/auth/providers/password/encryptor/bcrypt_encryptor"
...
func (provider Provider) ConfigAuth(auth *auth.Auth) {
	auth.Render.RegisterViewPath("github.com/ductrung-nguyen/auth/providers/password/views")

	if auth.Mailer != nil {
		auth.Mailer.RegisterViewPath("github.com/ductrung-nguyen/auth/providers/password/views/mailers")
	}
}
